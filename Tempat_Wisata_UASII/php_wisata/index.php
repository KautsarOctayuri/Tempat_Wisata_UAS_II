...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <br /><br />
      <h2>Tempat Wisata Selengkapnya</h2>
    </center>
  </body>
</html>
<?php
$query = "SELECT B.*,K.* FROM wisata B,kategori_wisata K WHERE B.id_kategori=K.id_kategori";
...
//
//tampilan berita
    echo "<font size=4><a href= 'wisata_lengkap.php?id=$id_wisata'>$judul</a></font><br>";
